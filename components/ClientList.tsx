    ...
    <div className="w-full md:w-80 bg-white border-r border-gray-200 flex flex-col h-full">
      ...
      <div className="p-3 border-b border-gray-200 bg-white">
        <button
          ...
          className="w-full px-4 py-2 bg-sky-400 hover:bg-sky-500 text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
      ...
      <div className="p-3 border-b border-gray-200 bg-white">
        <button
          ...
          className="w-full px-4 py-2 bg-teal-400 hover:bg-teal-500 text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
      ...
      <div className="p-3 border-b border-gray-200 bg-white">
        <button
          ...
          className="w-full px-4 py-2 bg-violet-400 hover:bg-violet-500 text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
      ...
      <div className="p-3 border-b border-gray-200 bg-white">
        <button
          ...
          className="w-full px-4 py-2 bg-blue-400 hover:bg-blue-500 text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
      ...
      <div className="p-3 border-b border-gray-200 bg-white">
        <button
          ...
          className="w-full px-4 py-2 bg-rose-400 hover:bg-rose-500 text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
      ...
      <div className="p-3 border-b border-gray-200 bg-white">
        <button
          onClick={onShowHelp}
          className="w-full px-4 py-2 bg-gray-400 hover:bg-gray-500 text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
