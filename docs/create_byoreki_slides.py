...
callout(s, 0.7, 5.7, 11.9, 0.95,
        "⚠️ 自動保存はありません",
        "入力したら必ず「保存する」ボタンを押してください。未保存の間は「未保存の変更があります」と表示されます。医療文書の読み取り結果は「病歴欄に反映」ボタンを押すまで反映されません。",
        warn=True)
...
callout(s, 0.7, 6.28, 11.9, 0.82,
        "⚠ 「病歴欄に反映」を押すまで保存されません",
        "読み取り結果は画面表示のみです。病歴テキストに反映するには「病歴欄に反映」ボタンを押してください。反映後は「保存する」を押すまで保存されません。",
        warn=True)
